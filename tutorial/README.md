...
This assumes Oracle is running on localhost and set up with the users, grants and test data described in the Debezium [Vagrant set-up](https://github.com/debezium/oracle-vagrant-box).

Also you must download the [Oracle instant client for Linux](http://www.oracle.com/technetwork/topics/linuxx86-64soft-092277.html) and put it into a directory named `debezium-with-oracle-jdbc/oracle_instantclient`.
